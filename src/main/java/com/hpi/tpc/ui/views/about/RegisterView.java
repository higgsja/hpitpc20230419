...
@Route(value = ABOUT_REGISTER_VIEW, layout = MainLayout.class)
@PageTitle(TITLE_PAGE_ABOUT + ":" + TITLE_PAGE_ABOUT_REGISTER)
@NoArgsConstructor
@PermitAll
...
//    @Autowired private AboutModel aboutModel;
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        this.tpcService.AppTracking("TPC:About:Register");
        this.removeAll();
                Label label = new Label();
        label.setText("TBD: Register");
        this.add(label);
